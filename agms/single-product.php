                ...
                <div class="row">
                                ...
                                <ul class="slides">
                                    <li data-thumb="admin/images/<?php echo $row['Image']; ?>">
                                        <div class="thumb-image">
                                            <img src="admin/images/<?php echo $row['Image']; ?>" data-imagezoom="true"
                                                class="img-fluid" alt=" ">
                                        </div>
                                    </li>
                                    <?php if ($row['Image1']): ?>
                                    <li data-thumb="admin/images/<?php echo $row['Image1']; ?>">
                                        <div class="thumb-image"> <img src="admin/images/<?php echo $row['Image1']; ?>"
                                    ...
                                    <li data-thumb="admin/images/<?php echo $row['Image2']; ?>">
                                        <div class="thumb-image"> <img src="admin/images/<?php echo $row['Image2']; ?>"
                                                data-imagezoom="true" class="img-fluid" alt=" "> </div>
                                    </li>
                                    <?php endif; ?>
                                    <?php if ($row['Image3'] != ''): ?>
                                    <li data-thumb="admin/images/<?php echo $row['Image3']; ?>">
                                        <div class="thumb-image"> <img src="admin/images/<?php echo $row['Image3']; ?>"
                                                data-imagezoom="true" class="img-fluid" alt=" "> </div>
                                    </li>
                                    <?php endif; ?>
                                    <?php if ($row['Image4'] != ''): ?>
                                    <li data-thumb="admin/images/<?php echo $row['Image4']; ?>">
                                        <div class="thumb-image"> <img src="admin/images/<?php echo $row['Image4']; ?>"
                                                data-imagezoom="true" class="img-fluid" alt=" "> </div>
                                    </li>
                                    <?php endif; ?>
                    ...
                    <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                        ...
                        <h4 style="color:#28a745;">
                            NPR <?php echo number_format($row['SellingPricing'], 2); ?>
                        </h4>
                        </p>
                        ...
                        <div class="occasion-cart d-flex gap-3">
                            <h4>
                                <button class="btn btn-success">
                                    <a href="art-enquiry.php?eid=<?php echo $row['apid']; ?>"
                                        style="color:white; text-decoration:none;">Enquiry</a>
                                </button>
                            </h4>
                            <h4>
                                <button class="btn btn-primary" style="margin-left: 10px;">
                                    <a href="buy.php?pid=<?php echo $row['apid']; ?>"
                                        style="color:white; text-decoration:none;">Buy Now</a>
                                </button>
                            </h4>
                        </div>
