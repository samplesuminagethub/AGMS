...
<body>
   ...
   <h4>
      <button class="btn btn-success">
         <a href="art-enquiry.php?eid=<?php echo $row['apid']; ?>" style="color:white; text-decoration:none;">Enquiry</a>
      </button>
   </h4>
   <h4>
      <button class="btn btn-primary" style="margin-left: 10px;">
         <a href="buy.php?pid=<?php echo $row['apid']; ?>" style="color:white; text-decoration:none;">Buy Now</a>
      </button>
   </h4>
</div>
